...
from gi.repository import Gtk, Gdk, GConf, cairo, PangoCairo, GObject

# Local imports
from . import MMapArea, UndoManager, PeriodicSaveThread, ImageThought, utils
#import UndoManager
...
class LabyrinthWindow (GObject.GObject):
    ...
    def __init__ (self, filename, imported=False):
        ...
        #glade = Gtk.glade.XML(utils.get_data_file_name('labyrinth.ui'))
        glade = Gtk.Builder()
        glade.add_from_file(utils.get_data_file_name('labyrinth.ui'))
