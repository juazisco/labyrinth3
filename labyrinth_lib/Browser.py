...
from gi.repository import Gtk, GObject, Pango, GConf
#import Gtk
#if os.name != 'nt':
#    import GConf
#import Gtk.glade
...
"59 Temple Place, Suite 330, Boston, MA  02111-1307  USA")
    ...
    def import_clicked(self, button, other=None, *data):
        chooser = Gtk.FileChooserDialog("Please choose a folder", self,
        ...
        filtr2 = Gtk.FileFilter ()
        filtr2.set_name(_('Todos los archivos'))
        filtr2.add_pattern('*.*')
        chooser.add_filter(filtr2)
